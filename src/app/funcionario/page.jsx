  ...
  return (
    <main className="container mx-auto mt-10">
      <div className="flex justify-between">
        ...
        <Link className="bg-purple-600 text-white rounded-full p-2" href={'/funcionario/cadastrar'}>Adicionar funcionário</Link>
      </div>
      <table className="mt-10 w-full p-5 border border-black">
        <thead>
        ...
        <tbody>
          ...
          {funcionarios.length > 0 && funcionarios.map((funcionario) => (
             <tr className="border border-black" key={funcionario.idFuncionario}>
              ...
              <td className="border border-black text-center">
                <Link href={"/funcionario/editar/" + funcionario.idFuncionario} className="material-symbols-outlined cursor-pointer">edit</Link>
                <button className="material-symbols-outlined cursor-pointer text-red-500" onClick={() => deletaFuncionario(funcionario.idFuncionario)}>delete</button>
              </td>
            </tr>
          ))}
        </tbody>
