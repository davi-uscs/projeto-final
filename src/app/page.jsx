...
export default function Home() {
  ...
  return (
    <main className="container mx-auto mt-10">
        ...
        <Image src={"/tabela.png"} alt="Tabela do sistema" width={600} height={600} />
        <h2 className="mt-10 text-lg font-semibold">Protótipo do sistema</h2>
        <Image src={"/prototipo-listagem.png"} className="mt-2" alt="Protótipo tela de listagem" width={600} height={600} />
        <Image src={"/prototipo-cadastro.png"} className="mt-2" alt="Protótipo tela de cadastro" width={600} height={600} />
    </main>
  )
}
